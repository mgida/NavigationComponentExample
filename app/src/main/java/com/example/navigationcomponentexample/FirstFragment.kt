...
class FirstFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.userInFirstFragTextView.text = "Hello ${args.userName} "
        binding.buttonPickFirst.setOnClickListener { view ->
            view.findNavController()
                .navigate(FirstFragmentDirections.actionFirstFragmentToPickFragment())
        }
